...
/**
 * LCD_Init : This function initializes the LCD 4bit
 * @param	void
 * @return	void
 */
void LCD_Init(void);
...
/**
 * LCD_Init : This function Clears the LCD 4bit
 * @param	void
 * @return	void
 */
void LCD_CLR(void);
...
/**
 * LCD_disply_char : This function displays a character on the LCD 4bit
...
/**
 * LCD_disply_string : This function displays whole string on the LCD 4bit
...
/**
 * LCD_disply_char_at_X_Y : This function displays a character on the LCD 4bit at specific position
...
/**
 * LCD_disply_string_at_X_Y : This function displays a whole string on the LCD 4bit at specific position
...
/**
 * LCD_disply_num : This function converts the nu,ber to string and displays it on the LCD 4bit
...
/**
 * LCD_disply_CustomCharacter : This function displays a custom on the LCD 4bit
 ...
 * 				LCD_disply_CustomCharacter(1, 5, customChar, 0);
 * @return	void
 */
